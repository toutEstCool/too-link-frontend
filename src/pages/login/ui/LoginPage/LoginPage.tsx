...
export const LoginPage: React.FC = () => {
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-background text-foreground overflow-hidden font-sans p-4">
      ...
      <div className="absolute inset-0 z-0 select-none pointer-events-none">
        <img 
          ...
          className="w-full h-full object-cover opacity-35 dark:opacity-30 scale-105 animate-[pulse_10s_infinite_alternate]"
        />
        {/* Комбинированные градиенты для эффекта глубины и легкой читаемости */}
        <div className="absolute inset-0 bg-gradient-to-t from-background via-background/70 to-transparent" />
        <div className="absolute inset-0 bg-radial-gradient from-transparent via-background/30 to-background/90" />
      </div>
